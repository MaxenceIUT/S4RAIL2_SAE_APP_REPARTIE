...
public interface ServiceGoodFood extends Remote {
     ...
     * @throws SQLException    Si une erreur SQL est survenue
     */
    void bookTable(String nomRestaurant, String nom, String prenom, String nombreInvites, String numTelephone, String dateRes) throws SQLException, RemoteException;
}
